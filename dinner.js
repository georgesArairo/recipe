...
input.addEventListener('keyup',function(){
  ...
  for (let i = 0; i < li.length; i++) {
   ...
   for (let i=0 ; i<image1Star.length ; i++){
      ...
      console.log(`dinner1: ${localStorage.getItem('dinner1')}`) ;  })
   }
   ...
   for (let i=0 ; i<image2Star.length ; i++){
      ...
      localStorage.setItem('dinner2', i+1) ;
      console.log(`dinner2: ${localStorage.getItem('dinner2')}`) ;
  })
   }
   ...
   for (let i=0 ; i<image3Star.length ; i++){
      ...
      localStorage.setItem('dinner3', i+1) ;
      console.log(`dinner3: ${localStorage.getItem('dinner3')}`) ;  })
   }
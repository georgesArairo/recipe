...
input.addEventListener('keyup',function(){
  ...
  for (let i = 0; i < li.length; i++) {
   ...
   for (let i=0 ; i<image1Star.length ; i++){
      ...
      localStorage.setItem('pizza1', i+1) ;
      console.log(`pizza1: ${localStorage.getItem('pizza1')}`) ;  })
   }
   ...
   for (let i=0 ; i<image2Star.length ; i++){
      ...
      localStorage.setItem('pizza2', i+1) ;
      console.log(`pizza2: ${localStorage.getItem('pizza2')}`) ;
  })
   }
   ...
   for (let i=0 ; i<image3Star.length ; i++){
      ...
      localStorage.setItem('pizza3', i+1) ;
      console.log(`pizza3: ${localStorage.getItem('pizza3')}`) ; 

...
input.addEventListener('keyup',function(){
  ...
  for (let i = 0; i < li.length; i++) {
   ...
   for (let i=0 ; i<image1Star.length ; i++){
      ...
      localStorage.setItem('pasta1', i+1) ;
      console.log(`pasta1: ${localStorage.getItem('pasta1')}`) ;  })
   }
   ...
   for (let i=0 ; i<image2Star.length ; i++){
      ...
      localStorage.setItem('pasta2', i+1) ;
      console.log(`pasta2: ${localStorage.getItem('pasta2')}`) ;
  })
   }
   ...
   for (let i=0 ; i<image3Star.length ; i++){
      ...
      localStorage.setItem('pasta3', i+1) ;
      console.log(`pasta3: ${localStorage.getItem('pasta3')}`) ;  })
   }
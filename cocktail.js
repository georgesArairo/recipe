...
input.addEventListener('keyup',function(){
  ...
  for (let i = 0; i < li.length; i++) {
   ...
   for (let i=0 ; i<image1Star.length ; i++){
      ...
      localStorage.setItem('cocktail1', i+1) ;
      console.log(`cocktail1: ${localStorage.getItem('cocktail1')}`) ;  })
   }
   ...
   for (let i=0 ; i<image2Star.length ; i++){
      ...
      localStorage.setItem('cocktail2', i+1) ;
      console.log(`cocktail2: ${localStorage.getItem('cocktail2')}`) ;
  })
   }
   ...
   for (let i=0 ; i<image3Star.length ; i++){
      ...
      localStorage.setItem('cocktail3', i+1) ;
      console.log(`cocktail3: ${localStorage.getItem('cocktail3')}`) ;  })
   }
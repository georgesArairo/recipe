...
input.addEventListener('keyup',function(){
  ...
  for (let i = 0; i < li.length; i++) {
   ...
   for (let i=0 ; i<image1Star.length ; i++){
      ...
      localStorage.setItem('dinner1', i+1) ;
      console.log(`breakfast1: ${localStorage.getItem('breakfast1')}`) ;  })
   }
   ...
   for (let i=0 ; i<image2Star.length ; i++){
      ...
      localStorage.setItem('breakfast2', i+1) ;
      console.log(`breakfast2: ${localStorage.getItem('breakfast2')}`) ;
  })
   }
   ...
   for (let i=0 ; i<image3Star.length ; i++){
      ...
      localStorage.setItem('breakfast3', i+1) ;
      console.log(`breakfast3: ${localStorage.getItem('breakfast3')}`) ;  })
   }
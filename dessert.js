...
input.addEventListener('keyup',function(){
  ...
  for (let i = 0; i < li.length; i++) {
   ...
   for (let i=0 ; i<image1Star.length ; i++){
      ...
      localStorage.setItem('dessert1', i+1) ;
      console.log(`dessert1: ${localStorage.getItem('dessert1')}`) ;  })
   }
   ...
   for (let i=0 ; i<image2Star.length ; i++){
      ...
      localStorage.setItem('dessert2', i+1) ;
      console.log(`dessert2: ${localStorage.getItem('dessert2')}`) ;
  })
   }
   ...
   for (let i=0 ; i<image3Star.length ; i++){
      ...
      localStorage.setItem('dessert3', i+1) ;
      console.log(`dessert3: ${localStorage.getItem('dessert3')}`) ;  })
   }
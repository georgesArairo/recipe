...
input.addEventListener('keyup',function(){
  ...
  for (let i = 0; i < li.length; i++) {
    ...
    //rating star
    const motherOfGlyphicon = document.querySelector('.motherOfGlyphicon') ;
   ...
   for (let i=0 ; i<image1Star.length ; i++){
      ...
      localStorage.setItem('vegeterian1', i+1) ;
      console.log(`vegeterian1: ${localStorage.getItem('vegeterian1')}`) ;  })
   }
   ...
   for (let i=0 ; i<image2Star.length ; i++){
      ...
      localStorage.setItem('vegeterian2', i+1) ;
      console.log(`vegeterian2: ${localStorage.getItem('vegeterian2')}`) ;
  })
   }
   ...
   for (let i=0 ; i<image3Star.length ; i++){
      ...
      localStorage.setItem('vegeterian3', i+1) ;
      console.log(`vegeterian3: ${localStorage.getItem('vegeterian3')}`) ;  })
   }
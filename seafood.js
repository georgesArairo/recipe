...
input.addEventListener('keyup',function(){
  ...
  for (let i = 0; i < li.length; i++) {
   ...
   for (let i=0 ; i<image1Star.length ; i++){
      ...
      localStorage.setItem('seafood1', i+1) ;
      console.log(`seafood1: ${localStorage.getItem('seafood1')}`) ;  })
   }
   ...
   for (let i=0 ; i<image2Star.length ; i++){
      ...
      localStorage.setItem('seafood2', i+1) ;
      console.log(`seafood2: ${localStorage.getItem('seafood2')}`) ;
  })
   }
   ...
   for (let i=0 ; i<image3Star.length ; i++){
      ...
      localStorage.setItem('seafood3', i+1) ;
      console.log(`seafood3: ${localStorage.getItem('seafood3')}`) ;  })
   }